...
public class SubCommandCreateIsland implements SubCommandPlayer
{
	...
	public boolean executePlayer(CommandSender sender, String[] args)
	{
		...
		if (this.islandDatabase.getOwner(player.getUniqueId()) != null)
		{
			player.sendMessage(this.prefix + "§7Vous avez déjà une île");
			return false;
		}
		...
		sessionIsland.setHomeLocation(sessionIsland.getCenterLocation());
		...
		player.teleport(sessionIsland.getHomeLocation());
